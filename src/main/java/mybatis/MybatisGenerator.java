 ...
 *
 */
public class MybatisGenerator extends DefaultCommentGenerator {// implements
  // CommentGenerator
  // {
  ...
  public static void main(String[] args) {
    args = new String[] {"-configfile", "src/main/resources/MybatisGeneratorConfig.xml", "-overwrite"};
